<template>
  <div style="transform: scale(0.8);">
    <svg :viewBox="`0 0 ${2*radius + srtokeWidth} ${radius + srtokeWidth}`" shape-rendering="optimizeQuality">
      <defs>
        <linearGradient id="linear" x1="0%" y1="0%" x2="100%" y2="0%" shape-rendering="optimizeQuality">
...
export default {
  ...
  computed: {
    startColor(){
      return this.options.startColor || '#F9E96B';
    },
    endColor(){
      return this.options.endColor || '#5CCD53';
    },
    durTime() {
      return this.options
